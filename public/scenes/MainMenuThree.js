...
export class StarsBackgroundView extends Common {
    ...
    addParticle() {
        const [x, y, z] = Array.from({ length: 3 }, () => THREE.MathUtils.randFloat(-100, 60));
    ...
    init() {
        ...
        this.particles = Array.from({ length: this.NUMBER_OF_STARS }, () => this.addParticle());
